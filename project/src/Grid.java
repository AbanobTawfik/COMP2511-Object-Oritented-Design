...
public class Grid {
    ...
    //create a media playable object with the media file for the collission sound
    //MediaPlayer hornMediaPlayer = new MediaPlayer(new Media(new File("files/sounds/bad.wav").toURI().toString()));
    //create a media file from the string with the sound file name
    //create a media playable object with the media file for victory sound
    //MediaPlayer victorySound = new MediaPlayer(new Media(new File("files/sounds/hit.wav").toURI().toString()));
    /**
     ...
     *
     * @param difficulty the difficulty of the game state
     */
    ...
    /**
     * This method will be used to play the media sound file for when a user has
     * collided the vehicle into an obstacle. This method will guarantee to play
     * the mp3 sound for a thump to represent a collision
     */
    public void playHit() {
        //to allow for reusability we want to reset sound everytime it is played
        //hornMediaPlayer.setStartTime(Duration.ZERO);
        //set file start to 0
        //hornMediaPlayer.seek(Duration.ZERO);
    ...
    /**
     * This method will be used to play the media sound file for when a user has
     * completed the current board state. This method will guarantee to play
     * the mp3 sound for victory to represent user has completed board state
     */
    public void playVictory() {
        //to allow for reusability we want to reset sound everytime it is played
        //victorySound.setStartTime(Duration.ZERO);
        //set file start to 0
        //victorySound.seek(Duration.ZERO);
        //play the victory sound for wining
        //victorySound.play();
