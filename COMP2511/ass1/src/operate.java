...
public class operate {
    ...
    public void outcomeBooking(String inputs[], ArrayList<Cinema> cinema) {
        ...
        boolean check = b.createBooking(numberOfTickets, movieTime, bookingId, cinemaNumber, cinema,sessionindex);
        if (check == false) {
    ...
    public void outcomeChange(String inputs[], ArrayList<Cinema> cinema) {
        ...
        boolean check = b.changeBooking(cinemaNumber,movieTime,numberOfTickets,cinema,sessionindex);
        if(check == false){
            System.out.println("Cancel rejected");
            return;
        }
