...
public class Grid {
    ...
    MediaPlayer hornMediaPlayer = new MediaPlayer(new Media(new File("../sounds/bad.wav").toURI().toString()));
    ...
    MediaPlayer victorySound = new MediaPlayer(new Media(new File("../sounds/hit.wav").toURI().toString()));
    /**
