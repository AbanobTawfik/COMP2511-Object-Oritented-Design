...
public class Grid {
    ...
    MediaPlayer hornMediaPlayer = new MediaPlayer(new Media(new File("sounds/bad.mp3").toURI().toString()));
    ...
    MediaPlayer victorySound = new MediaPlayer(new Media(new File("sounds/hit.mp3").toURI().toString()));
