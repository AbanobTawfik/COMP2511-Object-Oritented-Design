...
public class GridVariables {
     ...
     */
    //this is the resolution of the app on screen to fit user screen
    public static final double GRID_WIDTH = Screen.getPrimary().getVisualBounds().getWidth()-(Screen.getPrimary().getVisualBounds().getWidth()/5);

    /**
     * This constant will be the amount of pixels taken by the application when
     * the application is open in the Y direction
     */
    //this is the resolution of the app on screen to fit the user screen
    public static final double GRID_HEIGHT = Screen.getPrimary().getVisualBounds().getHeight()-(Screen.getPrimary().getVisualBounds().getHeight()/5);
