...
//        }
    ...
    public boolean BFSearch(BackEndState initialState) {
        ...
        while(!open.isEmpty()){
            ...
            for(BackEndCar bac: curr.getCurrent().getBackEndVehicles()){
                ...
                BackEndCar bec = clonedCar(bac, copy);
                copy.tryMoveVehicle(bec);
                searchNode add = new searchNode(copy, curr.getPreviousStates() + 1,curr);
                add.setScore();
    ...
    public BackEndCar clonedCar(BackEndCar bec, BackEndState bes){
