...
public class GridVehicle extends StackPane {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GridVehicle)) return false;
        GridVehicle that = (GridVehicle) o;
        return getRow() == that.getRow() &&
                getCol() == that.getCol() &&
                Double.compare(that.initialClickOffsetInX, initialClickOffsetInX) == 0 &&
                Double.compare(that.initialClickOffsetInY, initialClickOffsetInY) == 0 &&
                lastValidColumn == that.lastValidColumn &&
                lastValidRow == that.lastValidRow &&
                flag == that.flag &&
                isGoalCar() == that.isGoalCar() &&
                crashRow == that.crashRow &&
                crashCol == that.crashCol &&
                Objects.equals(getVehicle(), that.getVehicle()) &&
                Objects.equals(coordinatesBlocked, that.coordinatesBlocked) &&
